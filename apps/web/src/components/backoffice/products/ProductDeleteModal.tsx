          ...
          <>
            <ModalHeader className="flex flex-col gap-1 !bg-white">
              ...
              <span className="text-sm font-normal text-gulio-muted">
                Confirm before removing from the live catalog
              </span>
            </ModalHeader>
              ...
              <div className="flex gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p className="text-amber-900/90">
                    It will be archived from POS and the catalog. Past sales and
                    receipts stay intact — we never hard-delete sold items.
                  </p>
                </div>
              </div>
              {error ? (
